...
public partial class ArriveDemo : Node
{
    ...
    private CharacterBody2D arriver;
    ...
    {
        arriver = GetNode<CharacterBody2D>("Arriver2d");
        target_drawer = GetNode<Node2D>("TargetDrawer");
        target_drawer.Connect("draw", new Callable(this, nameof(_OnTargetDrawer_Draw)));
    ...
    public override void _PhysicsProcess(double delta)
    {
        ...
        gsai_agent._ApplySteering(gsai_accel, (float) delta);
    }
